...
<h1>Enterprise IT Infrastructure Simulation with AD DS</h1>

### Objective

This project is aimed to create and deploy directory services within the Microsoft Azure Cloud. 

> The purpose of this project is to demonstrate skills in setting up and managing Active Directory environments, including user and group management, DNS record management, and simulating realistic IT infrastructure with support scenarios. It serves as a hands-on example of how I would configure, organize, and troubleshoot in a professional IT setting. 

### Video Explanation
- ### [YouTube: How to Deploy Active Directory within Azure](https://youtu.be/3DdLuZPMMr8)

### Skills Learned
- Demonstrate the usage of AD DS in the environment 
- Join computers to the environment
- Simulate IT infrastructure with a database of employees with user management
- Simulate user lifecycle management 
- Simulate password resets and account lockouts scenarios
- Reading and understand event logs through Event Viewer
- Apply group policies respectively to groups
- Manage and configure DNS records and troubleshoot DNS misconfigurations
- Host and share files/folders with access level controls

### Environments and Tools Used
- Microsoft Azure for Virtual Machines 
- Windows 10 22H2 and Windows Server 2022
- Remote Desktop
...
> In Azure, we need to create a resource group along with a virtual network and two 2 virtual machines. One for the domain controller running Windows Server and the other being the client running Windows 10 to get started. 
...
- Back to the domain controller, open up Powershell ISE as an admin. Create a new file and paste contents of this Powershell script (it's in the repo). Run the script and observe all the accounts created in the ADUC. Choose a user and log into the client machine as them. Notice that it works.
